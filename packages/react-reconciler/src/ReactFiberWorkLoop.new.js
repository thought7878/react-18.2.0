...
function performConcurrentWorkOnRoot(root, didTimeout) {
  ...
  // 不包括高优先级的lane（低优先级的lane）并且不包括过期的lane 并且（disableSchedulerTimeoutInWorkLoop，或任务没有过期）
  ...
  // 如果渲染完成了，接下来是commit阶段；如果渲染未完成，处理各种情况
